  ...
  render() {
    ...
    return (
        <nav className="navbar navbar-dark fixed-top bg-dark  p-0 shadow" style={{height: 'calc(3vh + 24px)'}}>
          ...
          <a href="https://opensea.io/collection/the-onchain-canvas" rel="noopener noreferrer" target="_blank"><img className="navimage" src={OSlogo} style={{position: 'fixed', right: '50px'}}   alt="" /></a>
